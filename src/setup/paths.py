...
def make_data_directories():
    ...
    for path in [
        DATA_DIR, RAW_DATA_DIR, BOOK_STATS, PAGE_DETAILS, PAGE_DETAILS_WITH_SPACY, CHUNK_DETAILS_DIR, 
        PAGE_DETAILS_WITHOUT_SPACY, STATS_WITH_SPACY, STATS_WITHOUT_SPACY
    ]:
